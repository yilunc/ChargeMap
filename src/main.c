...
char name[32], addr[32], zip[7], hours[32], contype[32];
char name2[32], addr2[32], zip2[7], hours2[32], contype2[32];
char name3[32], addr3[32], zip3[7], hours3[32], contype3[32];
...
static void info_window_load(Window *window){
  ...
  s_bitmap_layer = bitmap_layer_create(GRect(80, 5, 16, 28));
